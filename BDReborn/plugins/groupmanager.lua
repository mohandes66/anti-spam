...
elseif lang then
 return "ارسال پیام های دارای مارک داون در گروه هم اکنون ممنوع است"
end
else
...
if not lang then
 ...
 return "ارسال پیام های دارای مارک داون در گروه ممنوع شد"
end
end
end
...
elseif lang then
return "ارسال پیام های دارای مارک داون در گروه ممنوع نمیباشد"
end
else 
...
return "ارسال پیام های دارای مارک داون در گروه آزاد شد"
end
end
end
...
elseif lang then
 return "بیصدا کردن اینلاین فعال است"
end
else
...
elseif lang then
return "بیصدا کردن اینلاین غیر فعال است"
end
else 
...
elseif lang then
 return "بیصدا کردن کیبورد فعال است"
end
else
...
elseif lang then
return "بیصدا کردن کیبورد غیرفعال است"
end 
else 
...
if ((matches[2] == "markdown" and not Clang) or (matches[2] == "مارک داون" and Clang)) then
...
*قفل* `[لینک | ورود | تگ | ویرایش | عربی | وب | ربات |اسپم | پیام مکرر | مارک داون | فراخوانی | سنجاق]`
_If This Actions Lock, Bot Check Actions And Delete Them_

*باز کردن* `[لینک | ورود | تگ | ویرایش | عربی | وب | ربات |اسپم | پیام مکرر | مارک داون | فراخوانی | سنجاق]`
_If This Actions Unlock, Bot Not Delete Them_

*بیصدا* `[همه | گیف | عکس | فایل | استیکر | کیبورد | فیلم | متن | فوروارد | موقعیت | اهنگ | صدا | مخاطب | اینلاین|بازی|خدمات تلگرام]`
_If This Actions Lock, Bot Check Actions And Delete Them_

*باصدا* `[همه | گیف | عکس | فایل | استیکر | کیبورد | فیلم | متن | فوروارد | موقعیت | اهنگ | صدا | مخاطب | اینلاین|بازی|خدمات تلگرام]`
_If This Actions Unlock, Bot Not Delete Them_

--Begin Tools.lua :)
local SUDO = 68723165 -- put Your ID here! <===
...
local text = matches[2]
tdcli.createNewChannelChat(text, 1, '@Wikigap', (function(b, d) tdcli.addChatMember(d.id_, msg.from.id, 0, dl_cb, nil) end), nil)
   if not lang then 
...
if ((matches[1] == 'asar' and not Clang) or (matches[1] == "اثر" and Clang)) then
...
_Sudoer And Admins Wikigap Bot Help :_
...
text = [[
_راهنمای ادمین و سودو های ربات ویکی گپ:_

...
local lang = redis:get(hash) 
 ...
 text = '_به تنظیمات گروه خوش آمدید_'
	...
	keyboard.inline_keyboard = {
		...
		{
			{text = "> قفل اسپم", callback_data='BeyondTeam'}, 
			{text = lock_spam, callback_data="/lockspam:"..GP_id}
		},
		{
		...
		{
			{text = "> قفل مارک داون", callback_data='BeyondTeam'}, 
			{text = lock_markdown, callback_data="/lockmarkdown:"..GP_id}
		},
		{
...
local lang = redis:get(hash) 
   ...
   elseif lang then
	...
	keyboard.inline_keyboard = {
		...
		{
			{text = "> بیصدا گیف", callback_data='BeyondTeam'}, 
			{text = mute_gif, callback_data="/mutegif:"..GP_id}
		},
		{
		...
		{
			{text = "> بیصدا فوروارد", callback_data='BeyondTeam'}, 
...
if matches[1] == '/lockmarkdown' then
   ...
   elseif lang then
			text = 'قفل مارک داون غیر فعال شد'
    end
...
if matches[1] == '/mutegif' then
   ...
   elseif lang then
    ...
    elseif lang then
        text = 'بیصدا کردن گیف غیر فعال شد'
    end
...
if matches[1] == '/beyond' then
	...
	keyboard.inline_keyboard = {
		{
			{text = '> Support ', url = 'https://t.me/Wikigap_bot'}, 
			{text = '> Buy ', url = 'https://goo.gl/drqqRu'}
		},
		{
			{text = '> Our Channel ', url = 'https://t.me/joinchat/AAAAAEIIU8fv9cyezOSIgA'}
		},
		{
   ...
   elseif lang then
	...
	keyboard.inline_keyboard = {
		{
			{text = '> ربات پشتیبانی ', url = 'https://t.me/Wikigap_bot'}, 
			{text = '> خرید ربات ', url = 'https://goo.gl/drqqRu'}
		},
		{
			{text = '> کانال ما ', url = 'https://t.me/joinchat/AAAAAEIIU8fv9cyezOSIgA'}
		},
		{
